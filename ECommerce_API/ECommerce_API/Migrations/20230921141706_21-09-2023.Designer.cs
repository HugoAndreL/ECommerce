...
namespace ECommerce_API.Migrations
{
    ...
    [Migration("20230921141706_21-09-2023")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerce_API.Models.Avaliacao", b =>
                {
            ...
            modelBuilder.Entity("ECommerce_API.Models.Endereco", b =>
                {
                    ...
                    b.Property<string>("Desc_Endereco")
                        .HasMaxLength(60)
            ...
            modelBuilder.Entity("ECommerce_API.Models.ProdComp", b =>
                {
                    b.Property<int?>("ProdutoId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerce_API.Models.Avaliacao", b =>
                {
                    b.HasOne("ECommerce_API.Models.Cliente", "Cliente")
                        .WithMany("Avaliacoes_Client")
                        .HasForeignKey("ClienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECommerce_API.Models.Produto", "Produto")
                        .WithMany("Avalicoes_Prod")
            ...
            modelBuilder.Entity("ECommerce_API.Models.Endereco", b =>
                {
                    b.HasOne("ECommerce_API.Models.Estoque", "Estoque")
                        .WithOne("Endereço_Estoque")
                        .HasForeignKey("ECommerce_API.Models.Endereco", "EstoqueId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("ECommerce_API.Models.ProdComp", b =>
                {
                    b.HasOne("ECommerce_API.Models.Compra", "Compra")
                        .WithMany("Produtos_Compra")
                        .HasForeignKey("CompraId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ECommerce_API.Models.Produto", "Produto")
                        .WithMany("Compras_Prod")
                        .HasForeignKey("ProdutoId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ECommerce_API.Models.Categoria", b =>
                {
                    b.Navigation("Produtos_Cat");
                });

            modelBuilder.Entity("ECommerce_API.Models.Cliente", b =>
                {
                    b.Navigation("Avaliacoes_Client");
            ...
            modelBuilder.Entity("ECommerce_API.Models.Compra", b =>
                {
                    b.Navigation("Produtos_Compra");
                });

            modelBuilder.Entity("ECommerce_API.Models.Estoque", b =>
                {
                    b.Navigation("Endereço_Estoque");
            ...
            modelBuilder.Entity("ECommerce_API.Models.Produto", b =>
                {
                    b.Navigation("Avalicoes_Prod");

                    b.Navigation("Compras_Prod");
